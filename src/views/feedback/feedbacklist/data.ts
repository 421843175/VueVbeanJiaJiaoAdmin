...
export const columns: BasicColumn[] = [
...

  {
    ...
    customRender: ({ text }) => {
      ...
      switch (text) {
        case 0:
        case '0':
          return h(Tag, { color: 'red' }, () => '未处理');
        case 1:
        case '1':
          return h(Tag, { color: 'green' }, () => '已处理');
      }
    },
    resizable: true,
  },
...

  {
    ...
    resizable: true,
    sorter: (a, b) => new Date(a.contactTime).getTime() - new Date(b.contactTime).getTime(), // 时间排序
  },
];
