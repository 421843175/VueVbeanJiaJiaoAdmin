<template>
  <div>
    ...
    <div gutter="24" style="margin-top: 1.5%; margin-left: 2%; padding-left: 5%">
      <Tag color="green"> 累计支付金额: {{ totalPaidAmount }} </Tag>
      <Tag color="red"> 累计退款金额: {{ totalRefundedAmount }} </Tag>
      <Tag color="blue"> 累计实收金额: {{ totalActualReceivedAmount }} </Tag>
      <Tag color="purple"> 累计交易笔数: {{ totalTransactions }} </Tag>
    </div>
    ...
    <SelectApplication @register="registerdemand" @confirm="handleModalConfirm" />
  </div>
</template>
<script lang="ts" setup>
  ...
  //TODO:NOTICE apis的配置
  import { listApplicationApi } from '@/api/demand/demandApi';
